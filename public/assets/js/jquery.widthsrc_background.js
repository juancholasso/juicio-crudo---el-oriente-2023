function widthSrcBackgroundRunOnce(func, scope){
...
jQuery.fn.widthSrcBackground = function(options){
  ...
  elms.each(
    function(i){
      ...
      $that.css("background-image", 'url('+$that.data("src-"+selectedThreshold)+')');
        ...
        if($that.data("src-"+threshold)){
          try{
            enquire.register("screen and (min-width: "+ threshold +"px)"+ 
              ...
              match: widthSrcBackgroundRunOnce(function(){ 
                      ...
                      if(that.maxLoaded < threshold) {
                        ...
                        $('<div>').css("background-image", 'url('+$that.data("src-"+threshold)+')').one("load", function(){
                          ...
                          .css({'background-image': 'url('+$that.data("src-"+threshold)+')'})
